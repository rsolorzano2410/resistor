export const AlertComponentConfig: any =
  {
    ...
    'table-columns' : [
      ...
      { 'title': 'TimeEvalWindow', 'name': 'IntervalCheck' },
      { 'title': 'EvalPeriod', 'name': 'AlertFrequency' },
      { 'title': 'ResendOn', 'name': 'AlertNotify' },
      ...
      { 'title': 'FieldEvalPeriod', 'name': 'FieldResolution' },
      ...
      { 'title': 'ProductTagLabel', 'name': 'DeviceIDLabel' },
      { 'title': 'ExtraTag', 'name': 'ExtraTag' },
      { 'title': 'ExtraTagLabel', 'name': 'ExtraLabel' },
      { 'title': 'ExtraData', 'name': 'ExtraData' },
      { 'title': 'UIDTag', 'name': 'IDTag' },
